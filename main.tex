...
\begin{minipage}{0.6\textwidth}
  \begin{Form}
    %\begin{tabular}{|cccc|}
    \begin{tabularx}{\textwidth}{| C{1.33} C{1.33} R{.33} R{1} |}
      \hline
      \TextField[name=class, width=0.3\textwidth, bordercolor=0 0 1]{}&
      ...
      \TextField[name=race, width=0.3\textwidth, bordercolor=0 0 1]{}&
      \TextField[name=align, width=0.3\textwidth, bordercolor=0 0 1]{}&
      \TextField[name=lvl, width=0.1\textwidth, bordercolor=0 0 1, format={formatLevel();}]{}&
      ...
      \textit{\footnotesize{Experience Pts}}\\
      \hline
    \end{tabularx}
    %\end{tabular}
  \end{Form}

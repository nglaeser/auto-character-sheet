...
\begin{minipage}{0.6\textwidth}
  \begin{Form}
    ...
    \begin{tabularx}{\textwidth}{| C{1.33} C{1.33} R{.33} C{1} |}
      ...
      \ChoiceMenu[name=race, width=0.3\textwidth, bordercolor=0 0 1, combo=true]{}{Human,Elf,Dwarf}&
  ...
  \begin{minipage}{.3\textwidth}
   ...
   \begin{Form}
     \begin{tabularx}{\textwidth}{|X|X|}
      ...
      %  \Huge{/}
      %  \TextField[name=hit-dice, width=2em,height=1.5em, charsize=1.5em, bordercolor=1 1 1, readonly=true, calculate={event.value = calcHitDice();}]{}
       & Failures\\

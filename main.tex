...
\begin{minipage}{0.6\textwidth}
  \begin{Form}
    \begin{tabular}{|ccc|}
      \hline
      \TextField[name=class-lvl, width=0.25\textwidth, color=0.18 0.55 0.34, bordercolor=0 0 1]{}&
      \TextField[name=bgnd, width=0.25\textwidth, color=0.18 0.55 0.34, bordercolor=0 0 1]{}&
      \TextField[name=name, width=0.25\textwidth, color=0.18 0.55 0.34, bordercolor=0 0 1]{}\\
      \textit{\footnotesize{Class \& Level}}& 
      \textit{\footnotesize{Background}}&
      \textit{\footnotesize{Player Name}}\\
      \TextField[name=race, width=0.25\textwidth, color=0.18 0.55 0.34, bordercolor=0 0 1]{}&
      \TextField[name=align, width=0.25\textwidth, color=0.18 0.55 0.34, bordercolor=0 0 1]{}&
      \TextField[name=xp, width=0.25\textwidth, color=0.18 0.55 0.34, bordercolor=0 0 1]{}\\
...
\begin{multicols}{3}
  %%% column 1 %%%
  \begin{minipage}{.1\textwidth} % Ability Scores
    \begin{tabular}{|c|}
      \hline
      Strength\\
      \\\\\\\\\hline
    ...
    \end{tabular}
  \end{minipage}
  \begin{minipage}{.2\textwidth} % Skills
    \begin{tabular}{|c|l|}
      \hline
      &Inspiration\\\hline
  ...
  \end{minipage}
                                                                                                     % Passive perception
   \begin{tabular}{|m{.05\textwidth}|m{.25\textwidth}|}
     \hline
     &\\
   ...
   %%% column 2 %%%
   \begin{Form}
     \begin{tabular}{|m{.1\textwidth}|m{.09\textwidth}|m{.09\textwidth}|}
       \hline
       &&\\
       &&\\
       &&\\

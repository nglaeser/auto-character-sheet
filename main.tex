...
\begin{insDLJS}[test]{test}{JavaScript}
  ...
  function processClass() {
    ...
    this.getField("strST").value = "Off";
    this.getField("dexST").value = "Off";
    this.getField("conST").value = "Off";
    this.getField("intST").value = "Off";
    this.getField("wisST").value = "Off";
    this.getField("chaST").value = "Off";
    ...
    switch (myclass) {
      case "Barbarian":
        this.getField("strST").value = "Yes";
        this.getField("conST").value = "Yes";
        profs = ["Simple weapons", "Martial weapons", "Light armor", "Medium armor", "Shields"];
        break;
      case "Bard":
        this.getField("dexST").value = "Yes";
        this.getField("chaST").value = "Yes";
        profs = ["Simple weapons", "Light armor"];
        break;
      case "Cleric":
        this.getField("wisST").value = "Yes";
        this.getField("chaST").value = "Yes";
        profs = ["Simple weapons", "Light armor", "Medium armor", "Shields"];
        break;
      case "Druid":
        this.getField("intST").value = "Yes";
        this.getField("wisST").value = "Yes";

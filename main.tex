  ...
  \begin{minipage}{.3\textwidth}
   ...
   \begin{tabularx}{\textwidth}{|@{}C{1}@{} C{0} @{}C{1}@{}|}
    ...
    %  &&\\&&\\&&\\&&\\&&\\&&\\
     &&\\
     \multicolumn{3}{|l|}{
      \TextField[width=.9\textwidth, height=5.6em, multiline=true, bordercolor=0 0 1,]{}}\\%
   ...
   \begin{tabularx}{\textwidth}{|L{1.2}L{.6}L{1.2}|}
     ...
     \textit{\footnotesize{Name}} & \textit{\footnotesize{Atk Bonus}} & \textit{\footnotesize{Damage/Type}}\\
      \TextField[width=.35\textwidth,bordercolor=0 0 1]{}&%
      \TextField[width=.17\textwidth,bordercolor=0 0 1]{}&%
      \TextField[width=.33\textwidth,bordercolor=0 0 1]{}\\[1ex]
      \TextField[width=.35\textwidth,bordercolor=0 0 1]{}&%
      \TextField[width=.17\textwidth,bordercolor=0 0 1]{}&%
      \TextField[width=.33\textwidth,bordercolor=0 0 1]{}\\[1ex]
      \TextField[width=.35\textwidth,bordercolor=0 0 1]{}&%
      ...
      \TextField[width=.35\textwidth,bordercolor=0 0 1]{}&%
      \TextField[width=.17\textwidth,bordercolor=0 0 1]{}&%
      \TextField[width=.33\textwidth,bordercolor=0 0 1]{}\\[.2ex]
   ...
   \begin{tabularx}{\textwidth}{|L{.6}@{}L{1.4}|}
     ...
     \multirow{10}*{
      \TextField[width=.6\textwidth, height=12.7em, multiline=true, bordercolor=0 0 1,]{}}\\[1ex]%
    %  \rule{.6\textwidth}{.2pt}\\
